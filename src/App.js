      ...
      <div className="min-h-screen bg-neutral-950 text-neutral-200 selection:bg-amber-500/30 selection:text-amber-200 font-sans overflow-x-hidden cursor-default">
          ...
          <ScrollReveal>
            <div className="max-w-4xl w-full mx-auto text-center">
              ...
              <div className="text-xl md:text-3xl text-neutral-400 font-light mb-12 h-12 flex items-center justify-center gap-3">
                <span>I build</span>
                {/* Updated Typewriter texts as requested */}
                <TypewriterText texts={[
                  'Full Stack Web Applications.',
                  'High-Performance Mobile Apps.',
                  'Proptech Inspection Robots.',
                  'Humanoid Residential Data.'
                ]} />
              </div>

              <p className="max-w-2xl mx-auto text-neutral-400 mb-12 leading-relaxed text-lg">
                Bridging the physical residential world with digital intelligence. Building scalable Proptech solutions and training the next generation of humanoid robots.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <ScrollReveal delay={0}>
                <TechCard
                    ...
                    tags={['React Native', 'Node.js', 'Go', 'GraphQL', 'iOS/Android']}
                />
              </ScrollReveal>
              <ScrollReveal delay={100}>
                <TechCard
                    ...
                    tags={['ROS2', 'SLAM', 'Computer Vision', 'IoT Sensors']}
                />
              </ScrollReveal>
        ...
        <section id="contact" className="py-32 px-6 text-center relative z-10">
          ...
          <footer className="absolute bottom-8 w-full text-center text-neutral-700 text-xs font-mono left-0">
            <div className="animate-pulse pb-3">_EOF_</div>
            &copy; 2025 ERIC LI / DEV_CORE. ALL RIGHTS RESERVED.
          </footer>
        </section>
      </div>
  );
